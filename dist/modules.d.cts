...
type StoreMapOptions = Omit<RootDatabaseOptions, "path">;
declare class StoreMap<K extends StoreMapKey = StoreMapKey, V = any> {
     ...
     */
    values(options?: RangeOptions): Generator<V, void, unknown>;
    /**
...
export { StoreMap, type StoreMapKey, type StoreMapOptions, StoreMapReader, StoreMapWriter };
