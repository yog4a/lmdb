import { S as StoreManager, a as PartitionOptions, P as PartitionManager } from './StoreManager-C7ivqce5.cjs';
...
declare class DayPartitionManager<K extends Key = Key, V = any> {
     ...
     */
    getPartition(tsSec: number, create?: boolean): PartitionManager<K, V> | undefined;
    /**
